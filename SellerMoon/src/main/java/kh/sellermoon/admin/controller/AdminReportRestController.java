...
public class AdminReportRestController {
	...
	// [[[[[[[[[[ 관리자 신고내역 전체조회 / 상세조회 / 조건검색 ]]]]]]]]]]
	@GetMapping("jsonReportList")
	public String jsonReportList(@RequestParam Map<String, Object> pMap) {
		logger.info("admin : jsonReportList 호출 성공");
		List<Map<String, Object>> reportList = null;
		reportList = reportLogic.reportList(pMap);
		String gReportList = null;
		Gson g = new Gson();
		gReportList = g.toJson(reportList);
		return gReportList;
	}
